...
import com.vipicu.demo.oauth.auth.support.base.CustomOAuth2AuthenticationConverter;
...
public class OAuth2ResourceOwnerPasswordAuthenticationConverter
		extends CustomOAuth2AuthenticationConverter<OAuth2ResourceOwnerPasswordAuthenticationToken> {
	...
	public boolean support(String grantType) {
		return CustomAuthorizationGrantType.PASSWORD.getValue().equals(grantType);
	}
	...
	public OAuth2ResourceOwnerPasswordAuthenticationToken buildToken(Authentication clientPrincipal,
		...
		return new OAuth2ResourceOwnerPasswordAuthenticationToken(CustomAuthorizationGrantType.PASSWORD, clientPrincipal,
